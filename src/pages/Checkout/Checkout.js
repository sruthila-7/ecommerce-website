...
import {removeAllItems} from "../../redux/action";
import './Checkout.css';
...
const Checkout = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setSuccessMessage(`Payment Successful, ${firstName} ${lastName}! Your order has been confirmed. Thank you for shopping with us.`);
    setSubmitted(true);
          ...
          <div className="row my-4">
            <div className="col-md-5 col-lg-4 order-md-last">
              <div className="card mb-4">
                <div id="order-summary-header" className="card-header py-3 bg-light">
                  <h5 className="mb-0">Order Summary</h5>
                </div>
                <div id="order-summary" className="card-body">
            ...
            <div className="col-md-7 col-lg-8">
              <div className="card mb-4">
                ...
                <div className="card-body billing-info">
                  <form className="needs-validation" onSubmit={handleSubmit}  noValidate autoComplete="off">
                    ...
                    <div className="row gy-3">
                      <div className="col-md-6">
                        ...
                        <input
                          ...
                          autoComplete="off"
                        />
                        <small className="card-fullname text-danger">
                    ...
                    <button className="w-30 btn continue-checkout-btn" type="submit">
